    ...
    <div className="order_history">
      <ul>
        <li
          ...
          className={`p4 ${tab.mode == 0 ? "tab-selected" : "tab"}`}
          onClick={() =>
        ...
        <li
          style={{ display: "inline" }}
          className={`p4 ${tab.mode == 1 ? "tab-selected" : "tab"}`}
        ...
        <li
          style={{ display: "inline" }}
          className={`p4 ${tab.mode == 2 ? "tab-selected" : "tab"}`}
        ...
        <li
          style={{ display: "inline" }}
          className={`p4 ${tab.mode == 3 ? "tab-selected" : "tab"}`}
      ...
      <div className="table_header">
        ...
        <span className="p4" style={{ width: "20%" }}>
          created
        </span>
        <span className="p4" style={{ width: "10%" }}>
          status
          ...
          if (tab.content.includes(el.status))
            return (
              <div className="table_body" key={idx}>
                ...
                <span className="p4" style={{ width: "10%" }}>
                  {(parseFloat(el.price) * parseFloat(el.amount)).toFixed(2)}
                </span>
                <span className="p4" style={{ width: "20%" }}>
                  {el.created}
                </span>
